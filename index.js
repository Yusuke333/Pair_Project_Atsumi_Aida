...
class PokemonData {
    ...
    async findPokemon(index) {
        ...
        const nameJa = species.names.filter((namePoke) => namePoke.language.name === "ja")[0].name;
        console.log(nameJa);

        //〇〇ポケモン
        const generaJa = species.genera.filter((namePoke) => namePoke.language.name === "ja")[0].genus;
